  ...
  switch (meta.status) {
    ...
    case ERROR:
      return {
        ...
        loading: false,
        errors: { ...state.errors, [type]: _.get(payload, 'data.errors') || _.get(payload, 'errors') || action.payload || [{'error':action.payload[0].error.response.data.msg}] },
      };
    case PENDING:
      return {
        ...state,
 ...
 * @param {Object}   success    Error container
